...
<table id="myData" align="center" width="90%" cellpadding="0" cellspacing="0"  style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px;">
	<thead>            
    	<tr>
			                    <th style="font-weight:bold" align="center" class="cfg_header" >KodeKecamatan</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >NamaKelurahan</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >IdKelurahan</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >KodePos</th> 
...
<script type="text/javascript">
	...
	$("document").ready(function(){
		var uri ='kelurahanDataReport.htm?';
			...
			success	: function(result){			
				...
				var no = 1;
				 $.each(x, function( index, value ) {
	                 var row = $("<tr>"+
	                       			        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.kodeKecamatan + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.namaKelurahan + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.idKelurahan + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.kodePos + "</font></div></td>"+
