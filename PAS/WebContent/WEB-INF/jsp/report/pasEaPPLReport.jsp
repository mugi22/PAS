...
<table id="myData" align="center" width="90%" cellpadding="0" cellspacing="0"  style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px;">
	<thead>            
    	<tr>
			                    <th style="font-weight:bold" align="center" class="cfg_header" >KodePPL</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >NamaPPL</th> 
...
<script type="text/javascript">
	...
	$("document").ready(function(){
		var uri ='pasEaPPLDataReport.htm?';
			...
			success	: function(result){			
				...
				var no = 1;
				 $.each(x, function( index, value ) {
	                 var row = $("<tr>"+
	                       			        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.kodePPL + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.namaPPL + "</font></div></td>"+
