        ...
        <table id="dg" title="COBA" class="easyui-datagrid" style="width:100%;"
            ...
            <thead>
                <tr>
                    ...
                    <th field="tglLhahir" width="100"sortable="true"><%=properties.getProperty("coba.TglLhahir")%></th> 
...
<!-- ************************** FORM ******************************************** -->
	<div id="dlg" class="easyui-dialog"	style="width: 750px;  padding: 10px 20px" closed="true"	buttons="#dlg-buttons" data-options="modal:true">
		...
		<table align="center"> 
                    <tr><td><div class="fitem">	<label><%=properties.getProperty("coba.Nik")%></label> :<input name="nik"	class="easyui-textbox" id="nik"></div></td></tr>	
                    <tr><td><div class="fitem">	<label><%=properties.getProperty("coba.Nama")%></label> :<input name="nama"	class="easyui-textbox" id="nama"></div></td></tr>	
                    <tr><td><div class="fitem">	<label><%=properties.getProperty("coba.TglLhahir")%></label> :<input name="tglLhahir"	class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" id="tglLhahir"></div></td></tr>	
...
function idRequired(t){
	...
	*/
	...
	function onShow() {
                    ...
                    $('#tglLhahir').textbox('readonly', true);
	...
	function onAdd() {
                    ...
                    $('#tglLhahir').textbox('readonly', false);
