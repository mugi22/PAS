...
<!-- ******************************FORM PENCARIAN******************************* -->   
        <div id="div2">
            ...
            <table align="center">  	                       
                    <tr>
<td><label style="width: 150px;"><%=properties.getProperty("userGroup.UserId")%></label> : <input name="UserId" type="text" id="UserId" size="30" maxlength="30"></td>
</tr>
                    <tr>
<td><label style="width: 150px;"><%=properties.getProperty("userGroup.GroupId")%></label> : <input name="GroupId" type="text" id="GroupId" size="30" maxlength="30"></td>
</tr>
...
var branchcode;
	...
	/*
		...
		if (row) {
			...
			$('#fm').form('clear');
			$('#fm').form('load', row);
			url = 'userGroupEdit.htm?'+"userId="+"${userId}";//?param='+row.kodeProvinsi+'&param2='+row.kodeKabupaten;
			onShow();
		}
		*/
	}
