...
/*===============================================REPORT==================================*/
function doCetak(){
		var repUrl = 'pasEaJenisPemeriksaanReport.htm?'+
					  'Status='+$('#Status').val()+"&"+'KodeJenisPemeriksaan='+$('#KodeJenisPemeriksaan').val()+"&"+'NamaJenisPemeriksaan='+$('#NamaJenisPemeriksaan').val()+"&"+'KeteranganJenisPemeriksaan='+$('#KeteranganJenisPemeriksaan').val()+"&"+"userId="+"${userId}";;
