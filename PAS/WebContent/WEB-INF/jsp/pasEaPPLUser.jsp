			...
			<table align="center">
				...
				<tr>
					<td><div class="fitem">
							...
							:<input name="lamaPPL" class="easyui-numberbox"
								data-options="min:0,precision:0,groupSeparator:','" id="lamaPPL">
						</div></td>
				<td></td>
					<td><div class="fitem">
				...
				<tr>
					<td><div class="fitem">
						...
						<td><div class="fitem">
							...
							:<input name="nilai" class="easyui-numberbox"
								data-options="min:0,precision:2,groupSeparator:','" id="nilai">
						</div></td>
				</tr>
				<tr>
						<td>
...
var branchcode;
	...
	function doShow() {
		...
		/*
			...
			if (row) {
				...
				$('#fm').form('clear');
				$('#fm').form('load', row);
				url = 'pasEaPPLUserEdit.htm?'+"userId="+"${userId}";//?param='+row.kodeProvinsi+'&param2='+row.kodeKabupaten;
				onShow();
			}
		 */
	}
	...
	function onAdd() {
		...
		$('#namaFileBuktiPPL').textbox('readonly', false);
		$('#fileBuktiPPL').textbox('readonly', false);
		$('#kodeUser').textbox('readonly', true);
