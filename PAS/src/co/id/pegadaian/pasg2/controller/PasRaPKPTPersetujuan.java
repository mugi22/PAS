...
@Controller
public class PasRaPKPTPersetujuan extends AbstractListScreen {
	@RequestMapping(value = "/PasRaPKPTPersetujuan.htm", method = RequestMethod.GET)
