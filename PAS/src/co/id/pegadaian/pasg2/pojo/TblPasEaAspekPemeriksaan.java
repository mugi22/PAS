...
@Entity
@Table(name = "TBL_PAS_EA_ASPEK_PEMERIKSAAN", schema = "PASG2")
public class TblPasEaAspekPemeriksaan extends AuditTrail implements
	...
	public TblPasEaAspekPemeriksaan() {
	}
