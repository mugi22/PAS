...
<table id="myData" align="center" width="90%" cellpadding="0" cellspacing="0"  style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px;">
	<thead>            
    	<tr>
                    ...
                    <th style="font-weight:bold" align="center" class="cfg_header" >NamaTkAuditan</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >KeteranganTkAuditan</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >StatusTkAuditan</th> 
...
<script type="text/javascript">
	...
	$("document").ready(function(){
		var uri ='pasEaTkAuditanDataReport.htm?';
        ...
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.namaTkAuditan + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.keteranganTkAuditan + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.statusTkAuditan + "</font></div></td>"+
