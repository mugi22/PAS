...
<!-- ************************** FORM ******************************************** -->
	<div id="dlg" class="easyui-dialog"	style="width: 750px;  padding: 10px 20px" closed="true"	buttons="#dlg-buttons" data-options="modal:true">
		...
		<table align="center"> 
                    <tr><td><div class="fitem">	<label><%=properties.getProperty("pasEaAspekPemeriksaan.KodeJenisPemeriksaan")%></label> :<input name="kodeJenisPemeriksaan"	class="easyui-textbox" id="kodeJenisPemeriksaan"></div></td></tr>	
                    <tr><td><div class="fitem">	<label><%=properties.getProperty("pasEaAspekPemeriksaan.KodeAspekPemeriksaan")%></label> :<input name="kodeAspekPemeriksaan"	class="easyui-textbox" id="kodeAspekPemeriksaan"></div></td></tr>	
                    <tr><td><div class="fitem">	<label><%=properties.getProperty("pasEaAspekPemeriksaan.NamaAspekPemeriksaan")%></label> :<input name="namaAspekPemeriksaan"	class="easyui-textbox" id="namaAspekPemeriksaan"></div></td></tr>	
                    <tr><td><div class="fitem">	<label><%=properties.getProperty("pasEaAspekPemeriksaan.KeteranganAspekPemeriksaan")%></label> :<input name="keteranganAspekPemeriksaan"	class="easyui-textbox" id="keteranganAspekPemeriksaan"></div></td></tr>	
                    <tr><td><div class="fitem">	<label><%=properties.getProperty("pasEaAspekPemeriksaan.TujuanAspekPemeriksaan")%></label> :<input name="tujuanAspekPemeriksaan"	class="easyui-textbox" id="tujuanAspekPemeriksaan"></div></td></tr>	
                    <tr><td><div class="fitem">	<label><%=properties.getProperty("pasEaAspekPemeriksaan.KdParent")%></label> :<input name="kdParent"	class="easyui-textbox" id="kdParent"></div></td></tr>	
                    <tr><td><div class="fitem">	<label><%=properties.getProperty("pasEaAspekPemeriksaan.Status")%></label> :<input name="status"	class="easyui-textbox" id="status"></div></td></tr>	
...
'Status='+$('#Status').combobox('getValue')+"&"+'KodeAspekPemeriksaan='+$('#KodeAspekPemeriksaan').val()+"&"+'KodeJenisPemeriksaan='+$('#KodeJenisPemeriksaan').combobox('getValue')+"&"+'KdParent='+$('#KdParent').val()+"&"+"userId="+"${userId}";
	...
	/*
		...
		if (row) {
			...
			$('#fm').form('clear');
			$('#fm').form('load', row);
			url = 'pasEaAspekPemeriksaanEdit.htm?'+"userId="+"${userId}";//?param='+row.kodeProvinsi+'&param2='+row.kodeKabupaten;
			onShow();
		}
		*/
	}
