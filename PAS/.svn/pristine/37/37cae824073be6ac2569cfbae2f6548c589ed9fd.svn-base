...
<table id="myData" align="center" width="90%" cellpadding="0" cellspacing="0"  style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px;">
	<thead>            
    	<tr>
			                    <th style="font-weight:bold" align="center" class="cfg_header" >KodeMataAnggaran</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >NamaMataAnggaran</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >NominalMataAnggaran</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >KodeRKAP</th> 
...
<script type="text/javascript">
	...
	$("document").ready(function(){
		var uri ='pasRaDetailRKAPDataReport.htm?';
			...
			success	: function(result){			
				...
				var no = 1;
				 $.each(x, function( index, value ) {
	                 var row = $("<tr>"+
	                       			        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.kodeMataAnggaran + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.namaMataAnggaran + "</font></div></td>"+
        "<td align='right'> <div class='cfg_detail'><font class='f_boldhd'>" + accounting.formatNumber(value.nominalMataAnggaran,0,'.',',') + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.kodeRKAP + "</font></div></td>"+
