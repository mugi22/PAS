...
<table id="myData" align="center" width="90%" cellpadding="0" cellspacing="0"  style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px;">
	<thead>            
    	<tr>
			                    <th style="font-weight:bold" align="center" class="cfg_header" >SukaSukaID</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >SukaName</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >SukaTgl</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >SukaGaji</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >SukaJmlx</th> 
...
<script type="text/javascript">
	...
	$("document").ready(function(){
		var uri ='sukasukaDataReport.htm?';
			...
			success	: function(result){			
				...
				var no = 1;
				 $.each(x, function( index, value ) {
	                 var row = $("<tr>"+
	                       			        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.sukaSukaID + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.sukaName + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.sukaTgl + "</font></div></td>"+
        "<td align='right'> <div class='cfg_detail'><font class='f_boldhd'>" + accounting.formatNumber(value.sukaGaji,0,'.',',') + "</font></div></td>"+
        "<td align='right'> <div class='cfg_detail'><font class='f_boldhd'>" + accounting.formatNumber(value.sukaJmlx,0,'.',',') + "</font></div></td>"+
