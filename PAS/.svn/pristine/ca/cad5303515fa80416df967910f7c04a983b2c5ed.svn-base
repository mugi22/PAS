...
<!-- ******************************FORM PENCARIAN******************************* -->   
        <div id="div2">
			...
			<table align="center">
				...
				<tr>
					<td><label style="width: 150px;"><%=properties.getProperty("provinsi.NamaProvinsi")%></label>
						: <input name="NamaProvinsi" type="text" id="NamaProvinsi"
						size="30" maxlength="30"></td>
				</tr>
...
<!-- **********************TABLE RESULT************************************** -->
        <table id="dg" title="PROVINSI" class="easyui-datagrid" style="width:100%;"
            ...
            <thead>
                <tr>
                    <th field="kodeProvinsi" width="100"sortable="true"><%=properties.getProperty("provinsi.KodeProvinsi")%></th> 
                    <th field="namaProvinsi" width="100"sortable="true"><%=properties.getProperty("provinsi.NamaProvinsi")%></th> 
...
<!-- ************************** FORM ******************************************** -->
	<div id="dlg" class="easyui-dialog"	style="width: 750px;  padding: 10px 20px" closed="true"	buttons="#dlg-buttons" data-options="modal:true">
		...
		<table align="center"> 
                    <tr><td><div class="fitem">	<label><%=properties.getProperty("provinsi.KodeProvinsi")%></label> :<input name="kodeProvinsi"	class="easyui-combobox" id="kodeProvinsi"></div></td></tr>	
                    <tr><td><div class="fitem">	<label><%=properties.getProperty("provinsi.NamaProvinsi")%></label> :<input name="namaProvinsi"	class="easyui-textbox" id="namaProvinsi"></div></td></tr>	
