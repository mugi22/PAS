...
<table id="myData" align="center" width="90%" cellpadding="0" cellspacing="0"  style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px;">
	<thead>            
    	<tr>
			                    <th style="font-weight:bold" align="center" class="cfg_header" >GroupId</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >MenuId</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >IsAdd</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >IsDelete</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >IsUpdate</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >IsView</th> 
...
<script type="text/javascript">
	...
	$("document").ready(function(){
		var uri ='priviledgeDataReport.htm?';
			...
			success	: function(result){			
				...
				var no = 1;
				 $.each(x, function( index, value ) {
	                 var row = $("<tr>"+
	                       			        "<td align='right'> <div class='cfg_detail'><font class='f_boldhd'>" + accounting.formatNumber(value.groupId,0,'.',',') + "</font></div></td>"+
        "<td align='right'> <div class='cfg_detail'><font class='f_boldhd'>" + accounting.formatNumber(value.menuId,0,'.',',') + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.isAdd + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.isDelete + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.isUpdate + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.isView + "</font></div></td>"+
