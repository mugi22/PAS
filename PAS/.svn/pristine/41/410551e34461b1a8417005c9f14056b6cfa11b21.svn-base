...
public class PasEaKetuaTimAuditorDAO {
	private Session session;
	
	public PasEaKetuaTimAuditorDAO(Session session){
...
/**
 * 	
 * @param kodeTkKantorAuditor
 * @param kodeKantorAuditor
 * @param kodeUserKetuaTimAuditor
 * @return
 */
