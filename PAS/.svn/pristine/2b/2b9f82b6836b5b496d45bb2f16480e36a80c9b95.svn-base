	...
	<div id="dlg" class="easyui-dialog"	style="width: 750px;  padding: 10px 20px" closed="true"	buttons="#dlg-buttons" data-options="modal:true">
		...
		<form id="fm" method="post" novalidate>
			<table align="center">
				<tr>
					<td><div class="fitem">
							<label><%=properties.getProperty("seq.SeqName")%></label> :<input
								name="seqName" class="easyui-textbox" id="seqName">
						</div></td>
				</tr>
				<tr>
					<td><div class="fitem">
							<label><%=properties.getProperty("seq.SeqNum")%></label> :<input
								name="seqNum" class="easyui-numberbox" id="seqNum">
						</div></td>
				</tr>

				<tr>
					<td><div class="fitem">
							<label><%=properties.getProperty("seq.Versi")%></label> :<input
								name="versi" class="easyui-numberbox" id="versi">
						</div></td>
				</tr>
